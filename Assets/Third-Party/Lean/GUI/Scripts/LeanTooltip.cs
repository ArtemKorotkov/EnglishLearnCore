...
namespace Lean.Gui
{
	...
	public class LeanTooltip : MonoBehaviour
	{
		...
		public ActivationType Activation { set { activation = value; } get { return activation; } } [SerializeField] protected ActivationType activation;

		/// <summary>This allows you to delay how quickly the tooltip will appear or switch.</summary>
		public float ShowDelay { set { showDelay = value; } get { return showDelay; } } [SerializeField] protected float showDelay;

		/// <summary>Move the attached Transform when the tooltip is open?</summary>
		public bool Move { set { move = value; } get { return move; } } [SerializeField] protected bool move = true;
		...
		public BoundaryType Boundary { set { boundary = value; } get { return boundary; } } [SerializeField] protected BoundaryType boundary;
		...
		public LeanPlayer ShowTransitions { get { if (showTransitions == null) showTransitions = new LeanPlayer(); return showTransitions; } } [SerializeField] protected LeanPlayer showTransitions;
		...
		public LeanPlayer HideTransitions { get { if (hideTransitions == null) hideTransitions = new LeanPlayer(); return hideTransitions; } } [SerializeField] protected LeanPlayer hideTransitions;

		/// <summary>This allows you to perform an action when this tooltip appears.</summary>
		public UnityEventString OnShow { get { if (onShow == null) onShow = new UnityEventString(); return onShow; } } [SerializeField] protected UnityEventString onShow;

		/// <summary>This allows you to perform an action when this tooltip hides.</summary>
		public UnityEvent OnHide { get { if (onHide == null) onHide = new UnityEvent(); return onHide; } } [SerializeField] protected UnityEvent onHide;

		[System.NonSerialized]
		protected LeanTooltipData tooltip;

		[System.NonSerialized]
		protected RectTransform cachedRectTransform;

		[System.NonSerialized]
		protected bool cachedRectTransformSet;
